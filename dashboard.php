...
$query = mysqli_query($conn, "Select count(emp_no) From sm_hr_emp");
...
<?php if (isset($_SESSION['success'])) : ?>
		...
		<?php  if (isset($_SESSION['username'])) : ?>
			<p style="color:red">Welcome Accounting Managemet Softwore</p>
		<?php endif ?>
        </div>
        ...
        <div class="col-md-6 col-lg-3">
          <div class="widget-small primary coloured-icon"><i class="icon fa fa-users fa-3x"></i>
            <div class="info">
              ...
              <p><b><?php echo $result['count(emp_no)'];?></b></p>
            </div>
          </div>
        </div>
        <!-- <div class="col-md-6 col-lg-3">
